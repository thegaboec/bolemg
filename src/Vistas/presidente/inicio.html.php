...
<br>
 ...
 <center>
      ...
      <div class="col-lg-6 col-md-8 mx-auto" style="color:#F3F5F8">
        <h1 class="fw-light text-dark">Secretaria</h1>
        </div>
 ...
 <center> <div class="  justify-content-center row align-items-md-stretch">
      <div class="p-5 col-md-5">
        <div class="h-100 p-5 text-white rounded-3 p-3 mb-2 bg-primary-subtle text-dark" >
          ...
          <p class="lead text-dark ">Podra registar una nueva secretaria cada vez que sea necesario, para ello debe llenar un formulario con los datos informativos de la nueva secretaria <p>
      ...
      <div class="p-5 col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
          ...
          <p class="lead ">Como presidente tendra la potestad de quitar privilegios de sessión a la secretaria cada vez que lo requiera pertinente, para eso debera activa o inactivar a la secretaria</div>
      </div>
    </div></center>
    <br>
    <center>
      ...
      <div class="col-lg-6 col-md-8 mx-auto" style="color:#F3F5F8">
        <h1 class="fw-light text-dark">Cambiar Contraseña</h1>
