<div class="content-documentacion p-5">
    ...
    <br>
        ...
        <thead class="p-5 table-primary ">
            ...
            <br>
            <a href="/secretaria/reporte/publicaciones" style="display:block; margin: 0.5rem auto;" class="col-sm-2 btn btn-primary btn-lg button-submit " type="submit">Imprimir</a>                          
        </form>
    </div>
</div>